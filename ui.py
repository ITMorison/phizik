...
def header():
    ...
    pipeline_actions = [
        ("🌽 ШИКІЗАТ", "pages/2_Управление_экспериментами.py"),
        ("▧ БИОПЛАСТИК", "pages/2_Управление_экспериментами.py"),
        ("⚗ ДЕРЕКТЕР", "pages/2_Управление_экспериментами.py"),
        ("⌘ PYTHON + AI", "pages/1_Аналитика.py"),
